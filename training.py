...
model = tflearn.DNN(net, tensorboard_dir='Back-end/models/tflearn_logs')
# Start training
model.fit(train_x, train_y, n_epoch=1000, batch_size=8, show_metric=True)
model.save('Back-end/models/model.tflearn')

pickle.dump( {'words':words, 'classes':classes, 'train_x':train_x, 'train_y':train_y}, open( "Back-end/models/training_data", "wb" ) )
